...
\paragraph*{Zadání známých hodnot} umožňuje parametr \texttt{baselfile}, do kterého vstupuje textový soubor
...
\texttt{expression} umo\-žňuje pomocí mapové algebry definovat nahrazení
...
\begin{description}
\item [t.rast.mapcalc] plně podporuje funkčnost mapové algebry \textit{r.mapcalc}. Z časoprosto\-rového modelu podporuje například start\_time, end\_time, které jsou nejčastěji využívané.
...
funkce GRASS tak pro časoprostorové analýzy. Výstupní formát modu\-lu podporující \textit{Temporal GRASS
...
interpolací srážek z linio\-vých reprezentací, které jsou zcela novým 
jevem na úrovni GIS. S velkou pravděpo\-dobností bude v~
...
založený na významněj\-ším datovém podkladu.
...
\bibitem{postgre}
CHEN, Hao, Heechul HEECHUL a Jin XIAO. \textit{Concept Architecture of PostgreSQL}. 2009. URL: \textless\url{http://www.inf.fu-berlin.de/lehre/WS09/DBS-Tech/Material/ConceptArchPostres.pdf}$>$

\bibitem{bares}
BARĚŠ, Pavel. \textit{Implementace materializovaných pohledů v PostgreSQL}. Praha, 2010. Bakalářská práce. ČVUT FIT. Vedoucí práce Ing. Zdeněk Kotala.
