...
\begin{figure}[h!]
 ...
 %%% to je ted...
 %%% MK: taky jsem po zkraceni, nevedel jsem ale kde ubrat...
...
V současné době jsou v rámci TeleMAS v ČR využíváno naměřených dat z
...
horizontální pola\-rizaci signálu (\texttt{polarization}), proto byl do
...
výstupu vhodném pro GIS analýzy. Modul pro výstupní data podporuje dvě
...
\begin{figure}[h!]%
    \centering
    \subfloat[Bikubická interpolace- nahrazení linie jedním bodem, sie=sin=0.01, lambda\_i=0.05;]{ \includegraphics[width=0.3\textwidth]{./img/intanalys/bic1.png} }%
    \qquad
    \subfloat[Bikubická interpolace body po 500 m,  sie=sin=0.01, lambda\_i=0.01]{ \includegraphics[width=0.3\textwidth]{./img/intanalys/bic500.png} }%
...
\begin{figure}[h!]%
    \centering
    \subfloat[IDW interpolace- nahrazení linie jedním bodem, npoints=15, power=1.5;]{ \includegraphics[width=0.3\textwidth]{./img/intanalys/idw1.png} }%
    \qquad
    \subfloat[IDW interpolace body po 500 m, npoints=150, power=1.5]{ \includegraphics[width=0.3\textwidth]{./img/intanalys/idw500.png} }%
...
\begin{figure}[h!]%
    \centering
    \subfloat[RST interpolace- nahrazení linie jedním bodem, tension $=30$]{ \includegraphics[width=0.3\textwidth]{./img/intanalys/rst1.png} }%
    \qquad
    \subfloat[RST interpolace body po 500 m, tension $=20$]{ \includegraphics[width=0.3\textwidth]{./img/intanalys/rst500.png} }%
