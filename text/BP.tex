...
V případě potřeby změny tabulky barev po výpočtu vlastního modulu, je možné editovat barevné škály moduly  \textit{r.color} pro rastrová data a  \textit{v.color} pro vektorová data. U těchto modulu je možné nadefinovat škálu barev z předpřipravených tabulek, či vytvořením vlastní.
...
\begin{figure}[h!]%
    ...
    \qquad
    \subfloat[IDW interpolace body po 500m]{ \includegraphics[width=0.3\textwidth]{./img/intanalys/idw500.png} }%
...
\begin{figure}[h!]%
    ...
    \qquad
    \subfloat[RST interpolace body po 500m]{ \includegraphics[width=0.3\textwidth]{./img/intanalys/rst500.png} }%
...
Modul {t.rast.out.vtk} umožňuje exportovat rastry do textové formy \textit{VTK DataFile Version 3.0}. Export tímto modulem je možnost, jak dávkově exportovat data z modulu \textit{r.mwprecip}.
...
\begin{figure}[h!]%
    \centering
    \subfloat[Agregace RST  ]{ \includegraphics[width=0.25\textwidth]{./img/intanalys/basin1.png} }%
    \qquad
    \subfloat[Transformace srážek]{ \includegraphics[width=0.25\textwidth]{./img/intanalys/basin2.png} }%
...
S ohledem na prvotní nároky zadavatele a neznalost jazyka Python je zdrojový kód aplikace psán procedurálně. V primární fázi vývoje byla tato volba výhodná avšak v posledních fázích implementace bylo zřejmé, že objektově orientovaný model by byl výhodnější. Modul \textit{r.mwprecip} je v současné době otevřený doplnění nových funkcí pro  určení baseline a to především pro rychlý vývoj nových metod. 
