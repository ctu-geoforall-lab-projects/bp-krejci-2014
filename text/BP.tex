...
probl\-émových okruhů, které jsou směřovány především k aplikaci v
...
\texttt{\acs{SRID}}.
%%% ML: standardem?
%, který je všeobecným standardem v GIS.
...
OGC \textit{Simple Features} (příklad v textové reprezentaci~WKT):
