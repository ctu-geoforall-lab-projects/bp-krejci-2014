...
a jsou současně volně dostupné pro uživatele GRASSu. 
...
V grafickém rozhraní GRASS je lze pomocí volby: settings $\Rightarrow$ addons extensions $\Rightarrow$
install extensions from addons, spustit prohlížeč dostupných Addons v GRASS repozitáři.
...
\begin{figure}[h!]
    ...
    \caption[DB]{Okno pro instalaci externích modulů z repozitáře  GRASS   \centering  }
 \end{figure}
