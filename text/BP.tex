...
\item \textbf{interpolace} - vytvoření plošných inter{subsec:postgresql}polací z \uv{časových oken}
\end{enumerate}
...
Uživatelské nastavení jednotlivých interpolací lze pomocí parametru \texttt{isettings}, do kterého je
...
PostgreSQL. K ní připojí zvolenou tabulku reprezentující \uv{časové
