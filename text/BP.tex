...
ve správě a analýze geografických dat. Jednotlivé nástroje GIS zpravidla nebývají
...
enviromentálního modelování. Jestliže se poohlédneme do počátku
...
modelování. Odhad a rekonstrukce srážek na zemském povrchu jsou
důležitou fází matematického modelování srážko-odtokových
...
povodněmi ohrožených oblastí městských aglomerací. Pokrokové
%%% ML: pouzivat zkratka MV, ale nevysvetlena
operativní metody určování srážek metodou MV spojů proto představují
...
obsahuje popis funkčnosti nástrojů, které vznikly v rámci této práce a jejich využití ve spojení s ostatními GIS nástroji.
