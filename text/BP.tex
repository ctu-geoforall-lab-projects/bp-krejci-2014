...
\paragraph*{Geografické informační systémy} současné doby, poměrně efektivně umožňují správu a analýzu srážkových dat. Jejich funkce jsou vhodné jak pro správu dat, tak pro její analýzu a vizualizaci. Jednotlivé metody měření srážek jsou mají specifické výstupy dat, ze kterých plynou různé nároky.

Srážkoměry produkují bodová data v různých časových intervalech, výstupem z radaru jsou snímky představující intenzitu srážek a satelitní družice produkují nespočet specifických druhů dat. Společné mají to, že je třeba jejich výstupy  co nejjednodušeji  spravovat a analyzovat. GIS nástroje splňují tyto požadavky poměrně dostatečně a částečně eliminují potřebu vývoje specifických systémů, které by měly z podstaty stejný základ.
