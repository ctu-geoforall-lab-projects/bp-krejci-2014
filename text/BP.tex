...
\subsubsection*{Časoprostorové analýzy}
...
\item Posledním krokem je spočtení objemu srážek, které spadly do daných povodí. K tomu je vhodný modul \textit{r.volume}, 
\begin{figure}[h!]
\begin{footnotesize}
\lstset{extendedchars=false,
escapeinside=''}
\begin{lstlisting}[style=mybash]
r.volume input=max15minute_148 clump=basin@test3 \
